...
-- We are going to examine what percent of the population is fully vaccinated
Select dea.continent, dea.location, dea.population, people_fully_vaccinated, (people_fully_vaccinated/dea.population)*100 as PercentPopulationVaccinated
From [Portfolio Project]..CovidDeaths dea
Join [Portfolio Project]..CovidVaccinations vac
	On dea.location = vac.location
	and dea.date = vac.date
where dea.continent is not null
Group by dea.location, dea.continent, dea.population, people_fully_vaccinated
